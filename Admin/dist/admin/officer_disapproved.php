...
<html>
  <head>
    ...
    <title>Disapproved Officer</title>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-times"></i> Disapproved Officer</h1>
          ...
          <div>
            <ul class="breadcrumb side">
              ...
              <li> Officer</li>
              <li class="active"><a href="#">Disapproved Officer</a></li>
            </ul>
          </div>
        </div>
<?php
    include "config.php";
    $disp=mysqli_query($connect,"select * from agriculture_officer where Officer_status ='disapproved' ") or die(mysqli_error($connect));
