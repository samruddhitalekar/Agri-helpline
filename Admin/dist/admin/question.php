...
<?php
    ...
    $disp=mysqli_query($connect,"select * from question order by Question_id desc") or die(mysqli_error($connect));
            ...
            <div class="card">
              ...
              ?>  
                    <tr>
                      ...
                      <a href="question_delete.php?question_id=<?=$Question_id  ?>"  onclick="return confirm('आपली खात्री आहे की आपण हे प्रश्न व उत्तर हटवू इच्छिता?');"  class="fa fa-trash-o text-danger fa-2x" type="submit" name="delete" style="padding-left:10px;" ></a></td>
