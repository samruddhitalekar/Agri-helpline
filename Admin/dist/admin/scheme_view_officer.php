    ...
    <title>योजना बघा</title>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-th-list"></i> योजना (कृषी अधिकारी) </h1>
          ...
          <div>
            <ul class="breadcrumb side">
              ...
              <li> योजना </li>
              <li class="active"><a href="#">योजना बघा (कृषी अधिकारी)</a></li>
            </ul>
          </div>
        </div>
<?php
    ...
    $disp=mysqli_query($connect,"select s.*,o.* from scheme s, agriculture_officer o where s.Scheme_person_name='Agriculture Officer' and s.Officer_id=o.Officer_id") or die(mysqli_error($connect));
