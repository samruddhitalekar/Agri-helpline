        ...
        <div class="page-title">
          ...
          <div>
            <ul class="breadcrumb side">
              ...
              <li class="active"><a href="#">Expire Product</a></li>
            </ul>
          </div>
        </div>
<?php
    ...
    $disp=mysqli_query($connect,"select p.*,e.* from product p, product_enquiry e where p.Product_id=e.Product_id and e.To_date='$current_date' and e.En_product_status='Booked' and p.Customer_id='".$_SESSION['customer_id']."' ") or die(mysqli_error($connect));
