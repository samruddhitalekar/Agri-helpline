    ...
    <title>Profile</title>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-edit"></i> Customer Profile</h1>
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                      <fieldset>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-6">
                            <input class="form-control" type="text" placeholder="Name" name="name" value="<?php echo $fetch['Customer_name']; ?>" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-6">
                            <input class="form-control" type="text" placeholder="Mobile" name="mobile" maxlength="10" pattern="[7-9]{1}[0-9]{9}" value="<?php echo $fetch['Customer_mobile']; ?>" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-6">
                            <div class="radio">
                              <label>
                                <input id="male" type="radio" name="gender" value="Male" <?php if($fetch['Customer_gender']=="Male"){ echo "checked";}?> required>Male
                              
                                <span  style="margin-left: 50px;">
                                <input id="female" type="radio" name="gender" value="Female" <?php if($fetch['Customer_gender']=="Female"){ echo "checked";}?> required>Female
                                </span>
                              </label>            
                          </div>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-6">
                          <textarea class="form-control" type="text" placeholder="Address" name="address" required><?php echo $fetch['Customer_address']; ?></textarea>
                        </div>
                      </div>
 ...
 if(isset($_POST['update']))
{
 ...
 $upload= "../images/customer/";
            ...
            unlink($upload.$fetch['Customer_photo']);
 ...
 $update=mysqli_query($connect,"update customer set
            ...
            where Customer_email='".$_SESSION['customer_email']."' ") or die(mysqli_error($connect));
 if($update)
        {
