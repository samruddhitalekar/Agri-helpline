...
include 'config.php';
    if(isset($_POST['login']))
    {
        ...
        $log=mysqli_query($connect,"select * from customer where Customer_email='$email' and Customer_password='$password' ") or die (mysqli_error($connect));
...
$email=$_POST['email'];
    ...
    if(filter_var($email, FILTER_VALIDATE_EMAIL) )
    {
        ...
        $add=mysqli_query($connect,"insert into customer(Customer_name, Customer_email, Customer_mobile, Customer_gender, Customer_address, Customer_password) values('$name', '$email', '$mobile', '$gender', '$address', '$password')") or die(mysqli_error($connect));
        ...
        <form class="login-form" method="post">
          ...
          <div class="form-group">
            <div class="utility">
              ...
              <p class="semibold-text mb-0">New Customer? <a data-toggle="flip"> Regitration</a></p>
            </div>
          </div>
          <br>
