 ...
 if(isset($_POST['submit']))
{
 ...
 $add=mysqli_query($connect,"insert into question_answer(Question_id,Answer_person_name, Officer_id,Answer) values('".$_GET['question_id']."','Agriculture Officer','".$_SESSION['officer_id']."','$answer')") or die(mysqli_error($connect));
