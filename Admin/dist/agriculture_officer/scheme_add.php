 ...
 if(isset($_POST['submit']))
{
 ...
 $add=mysqli_query($connect,"insert into scheme(Scheme_person_name,Officer_id,Scheme_name,Scheme_file,Scheme_file_type) values('Agriculture Officer','".$_SESSION['officer_id']."','$scheme_name','$scheme_file','$type2')") or die(mysqli_error($connect));
